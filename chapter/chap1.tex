...
%\hfill
\begin{minipage}{0.48\linewidth}
  \centerline{ \centering \includegraphics[width=0.8\textwidth]{chap1/endcapcheck-east-tot-histogram.eps}}
  \centerline{(b) 东端的原始TOT}
  \centerline{\label{fig:endcapcheck-east-tot-histogram}}
\end{minipage}
\vfill
\begin{minipage}{0.48\linewidth}
  \centerline{ \centering  \includegraphics[width=0.8\textwidth]{chap1/endcapcheck-west-t-histogram.eps}}
  \centerline{(c) 西端的原始时间}
  \centerline{\label{fig:endcapcheck-west-t-histogram}}
\end{minipage}
%\hfill
\begin{minipage}{0.48\linewidth}
  \centerline{ \centering \includegraphics[width=0.8\textwidth]{chap1/endcapcheck-west-tot-histogram.eps}}
